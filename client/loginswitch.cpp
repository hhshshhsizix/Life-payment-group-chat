...
LoginSwitch::LoginSwitch(QWidget *parent) : QWidget(parent)
{
    ...
    m_bgLabel->setStyleSheet("background-color: transparent; border-radius: 15px; border: 1px solid rgba(0, 255, 255, 1);");

    // 滑块
    m_slider = new QLabel(this);
    m_slider->setGeometry(0, 0, 50, 31);
    m_slider->setStyleSheet("background-color: rgba(0, 255, 255, 100); border-radius: 15px;");
