...
signals:
    ...
    void chatMessageReceived(QString fromUser, QString content, QString time, bool isPrivate = false, bool hasLocalAvatar = false); // 收到的消息
